...
.pc-price-alt{font-size:.58rem;font-weight:400;color:#8A9BB0;letter-spacing:normal;margin-left:6px}
...
@media(max-width:480px){
  ...
  section[style*="min-height:93vh"] > div[style*="position:relative;z-index"],.hero-inner{padding:20px 0 20px!important;position:relative!important;max-width:100%!important;width:100%!important}
...
section[style*="min-height:93vh"],.hero-section-zona{min-height:auto!important;padding-bottom:20px!important}
.hero-inner{padding:12px 0 8px!important}
