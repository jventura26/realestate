...
<section style="min-height:100vh;position:relative;display:flex;align-items:center;overflow:hidden;padding:0 6%;background:var(--ink)">
  ...
  <div class="hero-inner" style="position:relative;z-index:2;max-width:760px;padding:100px 0 130px">
    ...
    <div class="dv3-side-card wa-card">
      ...
      <div class="dv3-agent-row">
        ...
        <div>
          ...
          <div class="dv3-agent-role">Asesor inmobiliario</div>
        </div>
      </div>
...
function zonasIndexPage(zonasMap) {
  ...
  return layout({
    ...
    desc: 'Explora propiedades premium en las mejores zonas de Guatemala: Zona 10, Zona 14, Fraijanes, Cayala y mas.',
    canonical: '/zonas/',
    body: `<section style="padding:100px 6% 60px;text-align:center">
  <div class="ey" style="justify-content:center">Explorar por zona</div>
  <h1 class="st">Las mejores <em>zonas</em> de Guatemala</h1>
  <p class="ss" style="margin:0 auto 48px;text-align:center">Casas, fincas y apartamentos en las ubicaciones mas exclusivas del pais.</p>
