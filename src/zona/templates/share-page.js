function sharePage(prop) {
  ...
  return '<!DOCTYPE html>'
    ...
    + 'body{font-family:\'Montserrat\',sans-serif;background:#0a1628;color:white;padding:0!important;margin:0!important;}'
    + '.bg{display:none;}'
    + '.overlay{position:relative;z-index:1;min-height:100vh;background:linear-gradient(to bottom,rgba(10,22,40,1) 0%,rgba(10,22,40,1) 100%);display:flex;flex-direction:column;align-items:center;}'
