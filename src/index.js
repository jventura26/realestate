...
async function buildWhatsAppSystemPrompt(env, catalogo) {
  ...
  return [
    ...
    "9. Zona-INNmueble maneja tanto residencias premium como fincas y terrenos como vehiculo de inversion -- tenlo presente en cualquier conversacion sobre invertir. Si preguntan especificamente por fincas: primero revisa si el catalogo activo ya trae fincas listadas. Si NO trae ninguna en este momento, no te limites a decir que no hay nada -- aclara que Zona-INNmueble maneja fincas en distintas zonas del pais aunque ahora mismo no haya ninguna cargada en el catalogo activo, y ofrece -- sin forzarlo ni cambiar el tema de golpe -- mostrarle tambien residencias premium en Zona 10, Zona 14, Zona 16, Cayala, Fraijanes o Carretera a El Salvador, para darle mas opciones mientras se confirma disponibilidad de fincas. El objetivo es que la persona sienta que tiene mas alternativas, nunca que el catalogo esta vacio.",
    "9b. Si la conversacion es sobre invertir en general, sin que la persona haya especificado un tipo de propiedad, incluye de forma natural la opcion de finca o terreno junto a las residenciales al momento de calificar que busca (por ejemplo, al preguntar si prefiere algo mas orientado a renta, a plusvalia, o a un terreno/finca para el largo plazo) -- sin alargar la pregunta ni convertirla en una lista.",
