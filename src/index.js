...
function getAdminJS() {
  return [
    ...
    "  var data={titulo:titulo,precio:precio,tipo:document.getElementById('fTipo').value,operacion:document.getElementById('fOperacion').value,zona:document.getElementById('fZona').value,area:document.getElementById('fArea').value,habitaciones:document.getElementById('fHabitaciones').value,banos:document.getElementById('fBanos').value,imagen:imgM,mainImage:imgM,mainImageThumb:imgM,gallery:allG,descripcion:document.getElementById('fDescripcion').value,estado:document.getElementById('fEstado').value,sitios:sits,caracteristicas:getCheckedChars(),codigo:document.getElementById('fCodigo').value};",
