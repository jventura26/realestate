...
// Páginas adicionales 2024
const dashboardPage2024 = require('./pages/dashboard-2024');
const calculadoraPage2024 = require('./pages/calculadora-2024');

write(path.join(OUT, 'dashboard-2024.html'), dashboardPage2024()); console.log(' dashboard-2024.html');
write(path.join(OUT, 'calculadora-2024.html'), calculadoraPage2024()); console.log(' calculadora-2024.html');

console.log('\n ✅ Páginas 2024 generadas\n');
