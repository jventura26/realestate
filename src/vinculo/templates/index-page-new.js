...
<section style="background:linear-gradient(135deg,#1a2a4e 0%,#2d4069 100%);padding:clamp(60px,10vw,100px) 6%;text-align:center;position:relative;overflow:hidden">
  ...
  <div style="position:relative;z-index:1;max-width:900px;margin:0 auto">
    ...
    <p style="font-size:clamp(16px,3vw,20px);color:rgba(255,255,255,0.9);margin:20px 0 40px;line-height:1.6;max-width:700px;margin-left:auto;margin-right:auto">
      3 herramientas profesionales para invertir sin errores. Calcula, evalúa y compra las mejores propiedades premium de Guatemala.
    </p>
  </div>
</section>
...
<section style="padding:clamp(60px,8vw,80px) 6%;background:#f8f9fb">
  <div style="max-width:1300px;margin:0 auto">
    <div style="text-align:center;margin-bottom:60px">
      <h2 style="font-size:clamp(28px,5vw,42px);font-weight:700;color:#1a2a4e;margin:0 0 16px">Nuestras 3 Herramientas Premium</h2>
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(320px,1fr));gap:32px">
      ...
      <div style="background:white;border-radius:16px;overflow:hidden;box-shadow:0 8px 32px rgba(0,0,0,0.08);transition:all 0.3s;cursor:pointer" onmouseover="this.style.transform='translateY(-8px)';this.style.boxShadow='0 16px 48px rgba(0,0,0,0.15)'" onmouseout="this.style.transform='translateY(0)';this.style.boxShadow='0 8px 32px rgba(0,0,0,0.08)'">
        ...
        <div style="padding:32px 24px">
          <p style="color:#666;margin:0 0 24px;line-height:1.6">Simula tu hipoteca con tasas reales 2026 de los bancos principales de Guatemala.</p>
          <div style="background:#f8f9fb;border-radius:12px;padding:16px;margin-bottom:24px">
            ...
            <ul style="margin:8px 0;padding-left:20px;color:#555;font-size:13px">
              <li>Tasas de G&T, BAC, Industrial</li>
              <li>Cálculo de IUSI e impuestos</li>
              <li>Amortización mes a mes</li>
              <li>Simulación en tiempo real</li>
            </ul>
          </div>
          <a href="/herramientas/calculadora-hipotecaria.html" style="display:block;background:linear-gradient(135deg,#ffa500,#ff8c00);color:white;padding:14px;border-radius:8px;text-align:center;text-decoration:none;font-weight:700;transition:opacity 0.2s" onmouseover="this.style.opacity='0.9'" onmouseout="this.style.opacity='1'">
      ...
      <div style="background:white;border-radius:16px;overflow:hidden;box-shadow:0 8px 32px rgba(0,0,0,0.08);transition:all 0.3s;cursor:pointer" onmouseover="this.style.transform='translateY(-8px)';this.style.boxShadow='0 16px 48px rgba(0,0,0,0.15)'" onmouseout="this.style.transform='translateY(0)';this.style.boxShadow='0 8px 32px rgba(0,0,0,0.08)'">
        ...
        <div style="padding:32px 24px">
          <p style="color:#666;margin:0 0 24px;line-height:1.6">Estima el valor de tu propiedad en 20 zonas premium de Guatemala con datos 2026.</p>
          <div style="background:#f8f9fb;border-radius:12px;padding:16px;margin-bottom:24px">
            <div style="font-size:12px;color:#999;margin-bottom:6px">Incluye:</div>
            <ul style="margin:8px 0;padding-left:20px;color:#555;font-size:13px">
              <li>20 zonas analizadas</li>
              <li>Precios por m² actualizado</li>
              <li>Características y depreciación</li>
              <li>Análisis comparativo</li>
            </ul>
          </div>
          <a href="/herramientas/valuador.html" style="display:block;background:linear-gradient(135deg,#1a2a4e,#2d4069);color:white;padding:14px;border-radius:8px;text-align:center;text-decoration:none;font-weight:700;transition:opacity 0.2s" onmouseover="this.style.opacity='0.9'" onmouseout="this.style.opacity='1'">
            Acceder a Valuador →
          </a>
        </div>
      </div>
      ...
      <div style="background:white;border-radius:16px;overflow:hidden;box-shadow:0 8px 32px rgba(0,0,0,0.08);transition:all 0.3s;cursor:pointer" onmouseover="this.style.transform='translateY(-8px)';this.style.boxShadow='0 16px 48px rgba(0,0,0,0.15)'" onmouseout="this.style.transform='translateY(0)';this.style.boxShadow='0 8px 32px rgba(0,0,0,0.08)'">
        ...
        <div style="padding:32px 24px">
          <p style="color:#666;margin:0 0 24px;line-height:1.6">Guía completa: cómo comprar propiedades sin cometer errores costosos en Guatemala.</p>
          <div style="background:#f8f9fb;border-radius:12px;padding:16px;margin-bottom:24px">
            <div style="font-size:12px;color:#999;margin-bottom:6px">Incluye:</div>
            <ul style="margin:8px 0;padding-left:20px;color:#555;font-size:13px">
              <li>Análisis de mercado 2026</li>
              <li>Estrategia de financiamiento</li>
              <li>Checklist de inspección</li>
              <li>Negociación y cierre</li>
            </ul>
          </div>
          <a href="/herramientas/guia-compra.html" style="display:block;background:linear-gradient(135deg,#27ae60,#229954);color:white;padding:14px;border-radius:8px;text-align:center;text-decoration:none;font-weight:700;transition:opacity 0.2s" onmouseover="this.style.opacity='0.9'" onmouseout="this.style.opacity='1'">
            Descargar Guía →
          </a>
        </div>
      </div>
...
<section style="padding:60px 6%;background:white">
  <div style="max-width:1200px;margin:0 auto">
    <div style="text-align:center;margin-bottom:48px">
      ...
      <p style="font-size:16px;color:#666;margin:0">Las mejores opciones en zonas premium de Guatemala</p>
    </div>
    <div class="prop-grid">${featured.map(p => card(p)).join('')}</div>
    <div style="text-align:center;margin-top:48px">
      <a href="/propiedades.html" style="background:linear-gradient(135deg,#1a2a4e,#2d4069);color:white;padding:16px 48px;border-radius:8px;font-weight:700;text-decoration:none;font-size:16px;transition:opacity 0.2s;display:inline-block" onmouseover="this.style.opacity='0.9'" onmouseout="this.style.opacity='1'">
...
<section style="background:linear-gradient(135deg,#1a2a4e 0%,#2d4069 100%);padding:80px 6%;text-align:center;color:white">
  <div style="max-width:700px;margin:0 auto">
    ...
    <p style="font-size:18px;opacity:0.95;margin-bottom:32px;line-height:1.6">Comienza con nuestras herramientas gratuitas. Accede a datos profesionales, calcula financiamiento y toma decisiones inteligentes.</p>
    <div style="display:flex;gap:16px;flex-wrap:wrap;justify-content:center">
      <a href="/herramientas/valuador.html" style="background:white;color:#1a2a4e;padding:16px 32px;border-radius:8px;font-weight:700;text-decoration:none;transition:opacity 0.2s" onmouseover="this.style.opacity='0.9'" onmouseout="this.style.opacity='1'">
        Valuador →
      </a>
      <a href="/herramientas/calculadora-hipotecaria.html" style="background:#ffa500;color:white;padding:16px 32px;border-radius:8px;font-weight:700;text-decoration:none;transition:opacity 0.2s" onmouseover="this.style.opacity='0.9'" onmouseout="this.style.opacity='1'">
        Calculadora →
      </a>
...
`;
  ...
  return layout({ 
    title: null, 
    desc: `Plataforma premium de real estate en Guatemala. Calculadora hipotecaria, valuador profesional y guía de compra. ${props.length} propiedades verificadas.`, 
    canonical: '/', 
    body 
  });
}
