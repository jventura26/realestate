...
function indexPageNew(props, brokers) {
  ...
  const body = `
<style>@media(max-width:768px){.hero-section{padding:4px 3%!important;min-height:auto!important;display:block!important;height:auto!important}.hero-inner{padding:4px 3% 2px!important}.hero-section h1{font-size:clamp(1.3rem,5vw,1.8rem)!important;margin-bottom:8px!important}.hero-section p{margin-bottom:10px!important;font-size:12px!important}.stats-bar{position:static!important;backdrop-filter:none!important;background:rgba(255,255,255,.06)!important}.stats-bar>div{min-width:48%!important;padding:10px 8px!important;font-size:.65rem!important}.hero-section .hub-hero-tabs{margin-bottom:6px!important}.hero-section a[style*="padding:14px 28px"]{padding:10px 16px!important;font-size:12px!important}.hero-section button[onclick*="openHubFiltros"]{padding:10px 14px!important;font-size:11px!important}.hero-section div[style*="margin-bottom:10px"]{margin-bottom:8px!important}.hero-section div[style*="margin-bottom:16px"]{margin-bottom:8px!important}.hero-section form{margin-bottom:8px!important}.hero-section div[style*="max-width:560px"]{margin-bottom:8px!important}}</style><section class="hero-section" style="min-height:auto;position:relative;display:flex;flex-direction:column;align-items:center;background:#0a1628;overflow:hidden">
  ...
  <div class="hero-inner" style="position:relative;z-index:2;width:100%;max-width:1200px;margin:0 auto;padding:clamp(4px,2vw,100px) 4% clamp(2px,2vw,140px)">
