...
return`<div class="description"><h2>Descripci\u00F3n</h2><ul class="desc-list">${lines.map(l=>`<li class="desc-item"><span class="desc-bullet"></span><span>${escapeHtml(l.replace(/^\.+/,'').trim())}</span></li>`).join('')}</ul></div>`;
})();
