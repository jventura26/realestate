...
.nav-inner{display:flex;align-items:center;justify-content:space-between;height:auto;min-height:clamp(60px,14vh,100px);gap:clamp(6px,1vw,20px);padding:clamp(4px,0.5vh,16px) 0}
...
<div class="nav-inner">
<a href="/" class="logo">
<img src="${LOGO_BASE64}" alt="INMUHUB - La Red Profesional Inmobiliaria" style="height:clamp(50px,12vw,200px);width:auto;margin-right:clamp(4px,1.5vw,16px);">
