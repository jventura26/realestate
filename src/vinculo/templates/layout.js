...
<div class="nav-inner">
  <a href="/" class="logo" style="display:flex;align-items:center;text-decoration:none;flex-shrink:0">
    ...
    <a href="/blog/" style="font-size:13px;font-weight:500;color:#4a5568;padding:8px 14px;border-radius:6px;text-decoration:none;transition:all .2s;white-space:nowrap" onmouseover="this.style.color='#0f1b2e';this.style.background='#f7f8fa'" onmouseout="this.style.color='#4a5568';this.style.background='transparent'">Blog</a>
...
<footer style="background:#060e1c;color:white;margin-top:0;padding:0;border-top:1px solid rgba(255,255,255,.06)">
  ...
  <div style="max-width:1200px;margin:0 auto;padding:64px 6% 0">
    <div style="display:grid;grid-template-columns:2fr 1fr 1fr 1fr;gap:48px;margin-bottom:56px">
      ...
      <!-- HERRAMIENTAS -->
      <div>
        <h4 style="font-size:11px;font-weight:700;letter-spacing:.12em;text-transform:uppercase;color:var(--gold);margin:0 0 20px">Blog</h4>
        <div style="display:flex;flex-direction:column;gap:10px">
          <a href="/blog/" style="font-size:13px;color:rgba(255,255,255,.6);text-decoration:none;transition:color .2s" onmouseover="this.style.color='#C9A96E'" onmouseout="this.style.color='rgba(255,255,255,.6)'">Todos los articulos</a>
          <a href="/blog/guia-inversion-inmobiliaria-guatemala.html" style="font-size:13px;color:rgba(255,255,255,.6);text-decoration:none;transition:color .2s" onmouseover="this.style.color='#C9A96E'" onmouseout="this.style.color='rgba(255,255,255,.6)'">Guia de inversion</a>
          <a href="/blog/mejores-zonas-vivir-guatemala.html" style="font-size:13px;color:rgba(255,255,255,.6);text-decoration:none;transition:color .2s" onmouseover="this.style.color='#C9A96E'" onmouseout="this.style.color='rgba(255,255,255,.6)'">Mejores zonas</a>
        </div>
      </div>
      <div>
