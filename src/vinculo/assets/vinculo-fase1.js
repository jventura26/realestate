...
(function(){
  ...
  css.textContent = [
    ...
    '.ih-lb-close:hover{background:rgba(245,130,13,.2);color:var(--gold)}',
    ...
    '.ih-lb-nav:hover{background:rgba(245,130,13,.2);color:var(--gold)}',
    ...
    '.ih-lb-thumbs img.active{opacity:1;border-color:var(--gold,#F5820D)}',
